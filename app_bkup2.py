...
class Hydra(toga.App):
    ...
    def gb_link(self,geneid, browser): 
        ...
        try: 
            JulianoCheckbox = WebDriverWait(self.browser, 60).until(EC.presence_of_element_located(By.xpath,checkbox))
            print('Juliano Checkbox found')

        except TimeoutError: 
            print ('Jbrowser not loading')
